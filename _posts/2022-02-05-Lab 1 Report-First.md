...
However, a small error happened while working with Github: what I edited was not displayed on my website, which made me wait and wait for a while anxiously; finally, unable to wait more, I deleted and re-created my repository at Github, and it was the beginning point where the small issue with Github became a never-ending one that frustrated me greatly. I searched for information regarding the similar issue(s) to mine, but it was not found easily. 
